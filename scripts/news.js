...
function ajouter_recherche() {
    ...
    if (value_recherche != null && recherches.indexOf(value_recherche) === -1) {
        ...
        }; // on lui associe la fonction "selectionner_recherche"
        ...
        }; // on lui associe la fonction "supprimer-recherche"
...
function selectionner_recherche(elt) {
    ...
    if (recherches.indexOf(recherche_courante) != -1 && getCookie(recherche_courante)) {
        ...
        function iteration_fonction(value, index, array) {
            ...
            }; // on definit sa fonction lors d'un cick
        ...
        document.getElementById("resultats").innerHTML = ""; // si rien existe on vide tout
    }
...
function init() {
    ...
    // AMELIORATION 1: Remplissage automatique de la localisation actuelle
...
function callback(data) {
    document.getElementById("zone_saisie").value = data.city; // on recupere la position actuelle
...
function rechercher_nouvelles() {
    ...
    if (recherches.indexOf(value_recherche) != -1) { // si elle existe la recherche
        ...
        recherche_courante_news = []; // sinon on vide la variable globale, ligne de code pas obligatoire
    }
